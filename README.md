...
To install this operator on OpenShift 4.5+ for end-to-end testing, make sure you have access to a quay.io account to create bundle and index image repos. Follow the [authentication](https://github.com/operator-framework/operator-courier/#authentication) instructions for Operator Courier to obtain an account token. This token is in the form of "basic XXXXXXXXX" and both words are required for the command.
